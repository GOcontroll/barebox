...
struct imx8m_blk_ctrl_data {
	int max_reg;
	// int (*power_notifier_fn)(struct notifier_block *, unsigned long, void *);
...
static int imx8m_blk_ctrl_probe(struct device *dev)
{
...
static struct driver imx8m_blk_ctrl_driver = {
	.probe = imx8m_blk_ctrl_probe,
	.name = "imx8m-blk-ctrl",
	.of_match_table = imx8m_blk_ctrl_of_match,
};
coredevice_platform_driver(imx8m_blk_ctrl_driver);
MODULE_LICENSE("GPL");
